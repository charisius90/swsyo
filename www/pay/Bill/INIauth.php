...
/* INIauth.php
 *
 * 이니페이 플러그인을 통해 요청된 실시간 신용카드 본인인증을 처리한다.
 ...
 * 2. 정보 설정 *
 * ********************* */
$inipay->m_inipayHome = "/home/hsjung/www/INIpay41";   // 이니페이 홈디렉터리
$inipay->m_keyPw = "1111";       // 키패스워드(상점아이디에 따라 변경)
$inipay->m_type = "auth";       // 고정 (절대 수정금지)
$inipay->m_pgId = "INIpayAUTH";      // 고정 (절대 수정금지)
...
<html>
    ...
    <body>
        ...
        <table border=0 width=500>
            ...
            <tr>
                <td align=right nowrap>카드사 코드 : </td>
