 ...
 * 2. 정보 설정 *
 * ********************* */
$inipay->m_inipayHome = "/ssw1990/www/pay";//"/home/hsjung/www/INIformbill41";      // INIpay Home (절대경로로 적절히 수정)
...
$inipay->m_url = "https://shallwesay.co.kr";//"http://www.your_domain.co.kr";    // 상점 인터넷 주소
    ...
    <body>
        ...
        <table border=0 width=500>
            ...
            <tr>
                ...
                <td><font class=emp><?php echo iconv("EUC-KR", "UTF-8", $inipay->m_resultMsg); ?></font></td>
            </tr>
            <tr>
