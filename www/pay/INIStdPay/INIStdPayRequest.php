...
$mid = "shallwesay";//shallwesay qkrtn1qjsWkr! L3UwRHhsRDNSM25kV2cxMUdPK2VKdz09  // 가맹점 ID(가맹점 수정후 고정)$mid = "INIpayTest";
//인증
$signKey = "L3UwRHhsRDNSM25kV2cxMUdPK2VKdz09";//$signKey = "SU5JTElURV9UUklQTEVERVNfS0VZU1RS"; // 가맹점에 제공된 웹 표준 사인키(가맹점 수정후 고정) 
...
// POST 인자처리
list($goodname, $price) = explode('|', $_POST['subject']);
$merchantData = $_POST['mb_id'];
...
/* 기타 */
$siteDomain = "https://shallwesay.co.kr/pay/INIStdPay"; //가맹점 도메인 입력
        ...
        <script type="text/javascript">
			...
			*/
            function pay() {
				var fcheck = 1;
				var fmsg = '';
				if(document.SendPayForm_id.buyername.value == "") {
					var fcheck = 0;
					var fmsg = '이름을 확인해주세요';
				}
				if(document.SendPayForm_id.buyertel.value == "") {
					var fcheck = 0;
					var fmsg = '연락처를 확인해주세요';
				}
				if(document.SendPayForm_id.buyeremail.value == "") {
					var fcheck = 0;
					var fmsg = '이메일을 확인해주세요';
				}				
				if(fcheck) {
					INIStdPay.pay('SendPayForm_id');
				} else {
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" bgcolor="#FFFFFF" style="padding:20px">
                        ...
                        <tr>
                            <td><!--
                                ...
                                <br/><br/>
								-->
								이름 / 연락처 / 이메일등을 확인하시고 결제요청 버튼을 눌러주세요.
                            </td>
                        </tr>                        
                        <tr>
                            <td>
                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="SendPayForm_id" method="POST">
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <b>상품</b> :
                                                    <br/><input style="width:100%;" name="goodname" value="<?php echo $goodname ?>" readonly required>

                                                    <!--<br/><b>oid</b> : <br/>-->
                                                    <input type="hidden" style="width:100%;" name="oid" value="<?php echo $orderNumber ?>" >

                                                    <b>가격</b> :
                                                    <br/><input  style="width:100%;" name="price" value="<?php echo $price ?>" readonly required>
                                                    ...
                                                    <b>이름</b> :
                                                    <br/><input style="width:100%;" id="buyername" name="buyername" value="<?php echo $_POST['mb_name'] ?>" placeholder="홍길동" required>

                                                    <br/><b>연락처</b> :
                                                    <br/><input style="width:100%;" id="buyertel" name="buyertel" value="<?php echo $_POST['mb_tel'] ?>" placeholder="010-1234-5678" required>

                                                    <br/><b>이메일</b> :
                                                    <br/><input style="width:100%;" id="buyeremail" name="buyeremail" value="<?php echo $_POST['mb_email'] ?>" placeholder="test@inicis.com" required>
													...
													<input type="hidden" style="width:100%;" name="merchantData" value="<?php echo $merchantData ?>" required>
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/>인증결과 리턴시 함께 전달됨
                                                    <br/><input  style="width:100%;" name="merchantData" value="<?php echo $merchantData ?>" >
                                                </div>
												*/?>
                                            </form>
                                        </td>
