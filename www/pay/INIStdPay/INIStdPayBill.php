...
$mid 			= "INIBillTst";//"Bshallwesa";  								// 가맹점 ID(가맹점 수정후 고정)					
//인증
$signKey 		= "SU5JTElURV9UUklQTEVERVNfS0VZU1RS";//"NkR3SzlOaXlhTUpFS0NDMWtlZlVvUT09"; 			// 가맹점에 제공된 키(이니라이트키) (가맹점 수정후 고정) !!!절대!! 전문 데이터로 설정금지
...
/* 기타 */
$siteDomain = "https://".$_SERVER['HTTP_HOST']."/pay/INIStdPay"; //가맹점 도메인 입력
                                        ...
                                        <td style="text-align:left;">
                                            <form id="SendPayForm_id" name="" method="POST" >
                                                ...
                                                <div style="border:2px #dddddd double;padding:10px;background-color:#f3f3f3;">
                                                    ...
                                                    <br/><input  style="width:100%;" name="offerPeriod" value="M2" >
                                                    <br/>
                                                    <br/><b>acceptmethod</b> : 
